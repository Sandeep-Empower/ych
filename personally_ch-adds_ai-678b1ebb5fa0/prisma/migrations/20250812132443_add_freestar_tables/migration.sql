-- CreateTable
CREATE TABLE "ImpFreestarYsmHourly" (
    "date" DATE NOT NULL,
    ...
    CONSTRAINT "ImpFreestarYsmHourly_pkey" PRIMARY KEY ("date","hour","site_domain","traffic_source_code","type_tag","device_type","ad_type")
);
